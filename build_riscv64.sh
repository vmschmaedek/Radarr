...
#    rm -rf $testPackageFolder
    ...
    slnFile=src/Radarr.riscv64.slnx

    platform=Posix

    echo "Antes de fazer o clean dos objetos..."

#    dotnet clean $slnFile -c Debug
#    dotnet clean $slnFile -c Release

    echo "Iniciando build... Plataforma $platform | RID $RID"
...
echo "Vai comecar a construir os pacotes..."
...
then
    ...
    echo "Build com RID ${RID} e versao do framework ${FRAMEWORK}"
    Build
